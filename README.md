...
* [Frostybot-JS]([https://github.com/CryptoMF/frostybot-js](https://github.com/JulienPlanchetCoineo/frostybot-js)) - A Node.js API endpoint for cryptocurrency trading (e.g via TradingView webhooks)
